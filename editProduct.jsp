...
<body>
 <h2><a class="back" href="allProductEditProduct.jsp" style="color: green"><i class='fas fa-arrow-circle-left'> Back</i></a></h2>
<%
...
<select class="input-style" name="active">
 ...
 <button class="button" style="background-color: green">Save <i class='far fa-arrow-alt-circle-right'></i></button>
</form>
<%
 }
 }
